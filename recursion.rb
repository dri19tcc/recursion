...
# return boolean value, return strings, BC - use the length of the word in, RC - every time you test you strip off letters
# BC s.length == 0 || s.length == 1
def pal(s)
...
#in terminal write ruby recursion.rb
